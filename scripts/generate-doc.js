...
async function generateDoc() {
  ...
  try {
    ...
    console.log(
      chalk.green(
        `✓ Documentation file created at: ${path.relative(rootDir, filePath)}`,
      ),
    );
    ...
    console.log(
      chalk.dim("1. Edit the generated file to add more specific content"),
    );
