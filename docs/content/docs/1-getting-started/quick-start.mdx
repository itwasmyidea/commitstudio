...
- [Configuration Options](/docs/3-configuration/options) - Customize AI models and settings
- [Environment Variables](/docs/3-configuration/environment-variables) - Configure via environment 