...
- Continue to the [Quick Start](/docs/1-getting-started/quick-start) guide
- Learn about [Standard Mode](/docs/2-usage/standard-mode) for code analysis
- Explore [Configuration Options](/docs/3-configuration/options) to customize the tool 